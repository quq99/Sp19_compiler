...
public class AVRgenVisitor extends DepthFirstVisitor {
  ...
  public void outThisExp(ThisLiteral node) {
    String newname = node.getLexeme();
    if (newname.equals("this")) {
      //System.out.println("hhhhhhhhasfdjao");
      newname = "THIS";
  
    }
    VarSTE thisSTE = (VarSTE)(ST.lookupInnermost(newname));
    //System.out.println("hhhhhhhhasfdjao"+node.getLexeme());
    write2File(
      "\n\t# loading the implicit \"this\"" +
      "\n\t# load a two byte variable from base+offset" +
