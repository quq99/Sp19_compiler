...
"false"         { return new Symbol(sym.FALSE,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(0)));}
...
"true"         { return new Symbol(sym.TRUE,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(1)));}
...
"Meggy.Color.DARK"     { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(0)));}
"Meggy.Color.RED"      {return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(1)));}
"Meggy.Color.ORANGE"     { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(2)));}
"Meggy.Color.YELLOW"     { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(3)));}
"Meggy.Color.GREEN"     { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(4)));}
"Meggy.Color.BLUE"      { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(5)));}
"Meggy.Color.VIOLET"      { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(6)));}
"Meggy.Color.WHITE"     { return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(7)));}
"Meggy.Button.B"      { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(1)));}
"Meggy.Button.A"      { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(2)));}
"Meggy.Button.Up"     { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(4)));}
"Meggy.Button.Down"     { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(8)));}
"Meggy.Button.Left"     { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(16)));}
"Meggy.Button.Right"      { return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(32)));}
"Meggy.Tone.C3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(61157)));}
"Meggy.Tone.Cs3"      { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(57724)));}
"Meggy.Tone.D3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(54485)));}
"Meggy.Tone.Ds3"      { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(51427)));}
"Meggy.Tone.E3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(48541)));}
"Meggy.Tone.F3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(45816)));}
"Meggy.Tone.Fs3"      { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(43243)));}
"Meggy.Tone.G3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(40816)));}
"Meggy.Tone.Gs3"      { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(38526)));}
"Meggy.Tone.A3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(36363)));}
"Meggy.Tone.As3"      { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(34323)));}
"Meggy.Tone.B3"     { return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), new Integer(32397)));}
...
[_a-zA-Z][_a-zA-Z0-9]* { return new Symbol(sym.ID, new SymbolValue(yyline+1, yychar+1, yytext()));}
/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+/  { /*ignore the comments */ }
